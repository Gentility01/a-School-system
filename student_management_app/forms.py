...
from student_management_app.models import Classes, SessionYearModel, Term
...
class SessionTerm(forms.ModelForm):
    slug = forms.SlugField(label="Slug", max_length=50, widget=forms.TextInput(attrs=
                                                                               {"class":"form-control", 'placeholder':'Enter Slug'}))
    terms = forms.CharField(label="Enter term", max_length=50, widget=forms.TextInput(attrs=
...
class AddStudentForm(forms.Form):
    ...
    try:
        ...
        for classes in courses:
            single_course = (classes.id, classes.course_name)
