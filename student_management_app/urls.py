...
urlpatterns = [
    ...
    path('manage_subject_term/<slug:term_slug>/', HodViews.manage_subject_term, name="manage_subject_term"),
    path('manage_student_class/<int:id>/', HodViews.manage_student_class, name="manage_student_class"),
    path('manage_subject_class/<int:id>/', HodViews.manage_subject_class, name="manage_subject_class"),
    ...
    path('student_view_result_term/<int:id>/', StudentViews.student_view_result_term, name="student_view_result_term"),
